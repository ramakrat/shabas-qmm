...
const ReviewAssessment: NextPage = () => {
    ...
    const initialValues = {
        consensus_rating: selectedAssessmentQuestion?.answer?.consensus_rating ?? '',
        consensus_explanation: selectedAssessmentQuestion?.answer?.consensus_explanation ?? '',
        consensus_evidence: selectedAssessmentQuestion?.answer?.consensus_evidence ?? '',
    }
